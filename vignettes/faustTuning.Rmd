...
The vignette `faustIntro` shows how to use the `R` function <code style="color:skyblue">faust</code> to conduct end-to-end analysis of a cytometry dataset.
