...
Here are simulating generic data, and so will assume phenotypes that are `V1+` represent
a biological compartment of interest.
...
This demonstrates how to run `PFDA` on the `FAUST` count matrix.