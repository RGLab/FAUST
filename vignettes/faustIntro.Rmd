...
This parameter specifies how samples in the experiment should be combined in order for `FAUST` to perform discovery and
annotation.
...
Here we run `FAUST` at the individual sample level (which is its default setting),
so that each sample is analyzed separately.
